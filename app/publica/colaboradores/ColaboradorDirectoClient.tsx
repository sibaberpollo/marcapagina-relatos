...
export default function ColaboradorDirectoClient() {
  ...
  const { captchaRef, token, initTurnstile, resetTurnstile } = useTurnstile(TURNSTILE_SITEKEY)
  ...
  return (
    <div className="py-4">
      ...
      <article className="prose prose-lg dark:prose-invert mx-auto mb-5">
        ...
        <p>
          Bienvenido al portal exclusivo para colaboradores de MarcaPágina. Esta área está reservada
