  ...
  const renderContenido = () => {
    ...
    switch (estado) {
      ...
      case 'leyendo':
        ...
        if (typeof window !== 'undefined' && (window as any).gtag && desafio?.relatos?.[relatoActual]?.relato) {
          ...
          const autorRelato = desafio.relatos[relatoActual].relato.author && 
      ...
      case 'preguntas':
        ...
        const preguntasDelRelato = desafio.preguntas.filter((pregunta: any) => 
          pregunta.relatoId === desafio.relatos[relatoActual].relato._id
        );
