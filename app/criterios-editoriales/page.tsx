    ...
    <SectionContainer>
      <article className="mx-auto max-w-3xl">
        <div className="space-y-8 divide-y divide-gray-200 dark:divide-gray-700">
          <div className="pt-8 pb-8 prose prose-lg dark:prose-invert max-w-none">
            <PageTitle>Criterios Editoriales</PageTitle>
            
            <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100">Qué buscamos (y qué no) en los textos que recibimos</h2>
            
            <p className="text-gray-700 dark:text-gray-300">
              Leemos con atención. Y creemos en decir que no cuando un texto aún no está listo, incluso si tiene una "buena idea". No publicamos por compromiso ni por amabilidad. Publicamos lo que nos conmueve, lo que deja una imagen viva, una atmósfera, una voz.
            </p>

            <h3 className="text-lg font-bold mt-8 mb-4 text-gray-900 dark:text-gray-100">Lo que sí buscamos:</h3>
            ...
            <h3 className="text-lg font-bold mt-8 mb-4 text-gray-900 dark:text-gray-100">Lo que no publicamos:</h3>
            ...
            <h3 className="text-lg font-bold mt-8 mb-4 text-gray-900 dark:text-gray-100">❌ Y lo que especialmente no publicamos:</h3>
