        ...
        <div className="space-y-8 divide-y divide-gray-200 dark:divide-gray-700">
          <div className="pt-8 pb-8 prose prose-lg dark:prose-invert max-w-none"
            ...
            <p className="text-gray-700 dark:text-gray-300" 
               style={{ color: 'var(--color-text-light)' }}>
              En <a href="/transtextos" className="underline hover:underline">Transtextos</a> leemos con atención. Y creemos en decir que no cuando un texto aún no está listo, incluso si tiene una "buena idea". No publicamos por compromiso ni por amabilidad. Publicamos lo que nos conmueve, lo que deja una imagen viva, una atmósfera, una voz.
            </p>

            <h3 className="text-lg font-bold mt-8 mb-4 text-gray-900 dark:text-gray-100" 
                style={{ color: 'var(--color-text-light)' }}>
              Lo que sí buscamos:
            </h3>
            ...
            <p className="text-gray-700 dark:text-gray-300" 
               style={{ color: 'var(--color-text-light)' }}>
              Queremos que <a href="/transtextos" className="underline hover:underline">Transtextos</a> sea un espacio de lectura compartida, no una vitrina. Preferimos decir un "no" honesto a publicar algo que no está a la altura del proyecto.
            </p>
          </div>
        </div>
      </article>
