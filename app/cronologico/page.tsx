      ...
      <SectionContainer>
        <div className="space-y-2 pt-6 pb-4 md:space-y-5">
          ...
          <p className="text-lg leading-7 text-gray-700 dark:text-gray-300">
            Una colección cronológica de <strong>relatos</strong> escritos por autores emergentes de
            América Latina. Narrativa contemporánea, organizada por fecha.
          </p>
        </div>
        ...
        <div className="container">
          <ChronologicalView items={allRelatos} itemsPerPage={10} currentPage={currentPage} />
        </div>
      </SectionContainer>
    </>
  )
