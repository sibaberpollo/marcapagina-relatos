...
import HighlightStroke from '../common/HighlightStroke'
import PublishBanner from '../content/publishing/PublishBanner'
...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary-500 dark:bg-primary-400 mt-20 w-full">
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-8">
        {/* Banner de publicación */}
        <div className="flex flex-col items-center pt-12 pb-8 md:flex-row">
        ...
        <div className="flex flex-col items-center pb-12">
          <div className="mb-3 flex flex-col items-center space-y-2 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-6">
            ...
            <Link href="/acerca-de" className="text-gray-900 hover:text-gray-700">
              Acerca de
            </Link>
            <Link href="/publica" className="text-gray-900 hover:text-gray-700">
              Publica
            </Link>
            <Link href="/criterios-editoriales" className="text-gray-900 hover:text-gray-700">
